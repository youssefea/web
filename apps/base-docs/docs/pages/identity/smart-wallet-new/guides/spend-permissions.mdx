...
The following is a technical guide to build with Spend Permissions. If you want to learn more about high level details of this feature, check out the [Spend Permissions feature page](/identity/smart-wallet-new/concepts/features/optional/spend-permissions).
